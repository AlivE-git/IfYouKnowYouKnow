...
## Содержание
- [Часть 1. Ссылки для подключения](#часть-1-ссылки-для-подключения)
- [Часть 2. Настройка ПК](#часть-2-настройка-пк)
  ...
  - [Часть 2в. Настройка автозапуска](#часть-2в-настройка-автозапуска)
- [Часть 3. Настройка телефона](#часть-3-настройка-телефона)
  - [Часть 3а. Первоначальна настройка](#часть-3а-первоначальна-настройка)
  - [Часть 3б. Выбор приложений для VPN](#часть-3б-выбор-приложений-для-vpn)
- [Часть 4. Проверка (обязательная)](#часть-4-проверка-обязательная)
- [Часть 5. Обновление профиля](#часть-5-обновление-профиля)

## Часть 1. Ссылки для подключения
Для подключения будут использоваться ссылки подписки. 

Персонализированную ссылку можно получить [у бота в телеграме](https://t.me/poluchi_cfg_bot).

При первом запросе мне нужно будет добавить вас в базу, после можно будет обращатся в любой момент.
...
### Часть 2в. Настройка автозапуска
...
### Часть 3б. Выбор приложений для VPN
...
## Часть 5. Обновление профиля
Обновление будет происходить автоматически, но если появится срочная необходимость, сделайте сделующее:
- Нажмите на "Текущая конфигурация" в главном окне

<div align="center"><img src="images/4_profile.png" alt="drawing" width="400"/></div>

- Выберите второй пункт "Обновить"
